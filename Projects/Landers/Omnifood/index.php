...
<body>
    <header>
        ...
        <div class="hero-text-box">
            ...
            <a class="btn btn-ghost js--scroll-to-start" href="#">More info</a>
        </div>
    </header>

    <section class="section-feature js--section-feature" id="delivery">
        ...
        <div class="row">
            ...
            <p class="long-copy">Hello, we’re Omnifood, your new premium food delivery service. We know you’re always busy. No time for cooking.
                So let ustake care of that, we’re really good at it, we promise!</p>
        </div>
    ...
    <section class="section-meals clearfix">
        ...
        <ul class="meals-showcase clearfix">
            ...
            <li>
                <figure class="meal-photo">
                    <img src="resources/img/7.jpg" alt="Burger with cheddar
                        and bacon">
                </figure>
            </li>
            <li>
        ...
        <div class="row">
            <div class="col span-1-of-3">
                <blockquote>
                    ...
                    <cite>
                        <img src="resources/img/customer-1.jpg" alt="Alberto"> Alberto Duncan</cite>
                </blockquote>
            </div>
            <div class="col span-1-of-3">
                <blockquote>
                    ...
                    <cite>
                        <img src="resources/img/customer-2.jpg" alt="Joana"> Joana Silva</cite>
                </blockquote>
            </div>
            <div class="col span-1-of-3">
                <blockquote>
                    ...
                    <cite>
                        <img src="resources/img/customer-3.jpg" alt="Milton"> Milton Chapman</cite>
                </blockquote>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <form method="post" action="mailer.php" class="contact-form">
                    <div class="row">
                        ...
                        if($_GRT['success']==-1) {
                            echo "<div class=\"form-messages error\">Oops! somthing went wrong. Please try again.</div>";
                        }
    ...
    <footer>
        ...
        <div class="row">
            <p>
                Copyright &copy; 2014 by Omnifood. All rights reserved.
            </p>
        </div>
    </footer>
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDiwUZPMxhg2xogzEaVfeLJDar5hdBZyKo&callback=initMap"></script>
    ...
    <script>
        ...
        function initMap() {
            var uluru = { lat: 32.05, lng: 34.85 };
            var map = new google.maps.Map(document.getElementById('map'), {
                zoom: 12,
                center: uluru
            });
            var marker = new google.maps.Marker({
                position: { lat: 32.05, lng: 34.99 },
                map: map,
                title: 'Tel-Aviv'
