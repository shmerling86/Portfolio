...
var budgetController = (function () {
    ...
    return {
        ...
        calculateBudget: function () {
            ...
            // calculate the percentage of inc that we spant
...
var UIController = (function () {
    ...
    return {
        getinput: function () {
            return {
                type: document.querySelector(DOMstrings.inputType).value, //kind of input inc or exp
...
var controller = (function (budgetCtrl, UICtrl) {
    ...
    var ctrlAddItem = function () {
        ...
        if (input.description !== "" && !isNaN(input.value) && input.value > 0) {
            // 2. Add the item to the budget contraller
